...
public class TransactionController {
    ...
    /**
     * Retrieves paginated transactions belonging to the authenticated user.
     */
    @GetMapping
    public ResponseEntity<Page<TransactionResponse>> getAllTransactions(
        ...
        Page<TransactionResponse> responsePage = transactionService.getAllTransactionsForCurrentUser(pageable);
